...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <!-- ═══ Mapping catégorie → espace ═══ -->
        <h5 style="border-bottom: 2px solid #e53e3e; padding-bottom: 8px; margin-top: 25px; color: #e53e3e;">
            <i class="fa fa-sitemap"></i> Mapping catégorie WordPress → espace HumHub
        </h5>

        <div class="alert alert-warning" style="font-size: 13px;">
            <i class="fa fa-lightbulb-o"></i>
            <strong>Optionnel :</strong> Associez chaque catégorie WordPress à un espace HumHub spécifique.
            Les posts dont la catégorie n'est pas mappée iront dans l'espace cible par défaut ci-dessus.
        </div>

        <div class="row">
            <div class="col-md-12">
                <?= $form->field($model, 'categorySpaceMapping')->textarea([
                    'rows' => 4,
                    'placeholder' => '{"Revue de presse": 5, "Actualités du conseil": 3, "Communiqués": 8}',
        ...
        <div class="row" style="margin-bottom: 15px;">
            <div class="col-md-12">
                <p class="text-muted" style="font-size: 12px;">
                    <strong>Espaces disponibles :</strong>
                    <?php foreach ($spaces as $space): ?>
                        <code><?= Html::encode($space->name) ?></code> (ID: <?= $space->id ?>)
                        &nbsp;·&nbsp;
                    <?php endforeach; ?>
                </p>
            </div>
