 ...
 *  - Gestion des posts Majliss synchronisés
...
class AdminController extends Controller
{
    ...
    /**
     * Lance manuellement la synchronisation Majliss → HumHub.
     */
        ...
        try {
            ...
            Yii::$app->session->setFlash('success',
                Yii::t('ExternalHtmlStreamModule.base',
                    'Synchronisation terminée. {success} succès, {errors} erreur(s) sur {total} post(s).',
                    $result
                )
            );
        } catch (\Exception $e) {
    ...
    /**
     * Teste la connexion à la base Majliss (AJAX).
     */
    ...
    public function actionRetrySync($id)
    {
        try {
            ...
            if ($success) {
                Yii::$app->session->setFlash('success', 'Post resynchronisé avec succès.');
            } else {
