        ...
        <div class="d-flex justify-content-between align-items-center" style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <div>
                ...
                <button type="button" class="btn btn-sm btn-default" id="btn-test-connection">
                    <i class="fa fa-plug"></i> Tester connexion
                </button>
    ...
    <div class="panel-body">
        <?php if (empty($majlissPosts)): ?>
            <div class="text-center" style="padding: 30px;">
                ...
                <p class="text-muted">Cliquez sur "Synchroniser maintenant" pour récupérer les posts depuis WordPress.</p>
            </div>
        <?php else: ?>
...
$js = <<<JS
// Test connexion Majliss
$('#btn-test-connection').on('click', function() {
    var btn = $(this);
    var resultDiv = $('#connection-test-result');
    btn.prop('disabled', true).find('.fa').addClass('fa-spin');
    resultDiv.html('<div class="alert alert-info"><i class="fa fa-spinner fa-spin"></i> Test en cours...</div>').show();
